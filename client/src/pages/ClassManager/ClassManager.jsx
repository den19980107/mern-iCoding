...
const ClassManager = () => {
    ...
    // 檢查使用者是不是此課程老師
    useEffect(() => {
        if (userData && userData._id && classData && classData.teacherInfo && classData.teacherInfo._id) {
            SetIsTeacher(userData._id == classData.teacherInfo._id)
        }
    }, [classData, userData])
            ...
            >
                <div style={{ padding: "1rem" }}>
                    {isTeacher ?
                        ...
                        :
                        <p style={{ padding: 0, margin: 0, color: theme == "dark" ? "white" : "black" }}>所有單元</p>
                    }
                </div>
